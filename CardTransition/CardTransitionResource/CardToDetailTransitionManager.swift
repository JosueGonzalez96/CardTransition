...
final class CardToDetailTransitionManager: UIPercentDrivenInteractiveTransition, UIViewControllerTransitioningDelegate {
    ...
    weak var cardDetailViewController: CTDetailItemVC? {
        didSet {
            self.panGesture.addTarget(self, action: #selector(self.handlePan(gesture:)))
            self.panGesture.delegate = self
          self.cardDetailViewController?.interactivityDelegate = self as CTDetailItemInteractivityDelegate
    ...
    typealias InitParameters = (fromCardFrame: CGRect, fromCardFrameWithoutTransform: CGRect, viewModel: CardCollectionViewCellViewModel, fromCell: CTMainCell)
    ...
    init(_ params: InitParameters) {
      ...
      self.fromCell = fromCell as? CTMainCell
...
extension CardToDetailTransitionManager: CTDetailItemInteractivityDelegate {
...
extension CardToDetailTransitionManager: UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let detailVc = (self.isPresenting ? screens.to : screens.from) as! CTDetailItemVC
